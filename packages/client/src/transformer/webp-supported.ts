// reference https://github.com/maplibre/maplibre-gl-js/blob/04ff47d53ec16e17b92475fe9028c1477f6df02f/src/util/webp_supported.ts
...
let glForTesting: WebGLRenderingContext | null;
let webpCheckComplete = false;
let webpImgTest: TexImageSource;
